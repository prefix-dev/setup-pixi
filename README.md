...
```yml
- uses: prefix-dev/setup-pixi@v0.5.3
  with:
...
> Please pin the versions of this action to a specific version (i.e., `prefix-dev/setup-pixi@v0.5.3`) to avoid breaking changes.
